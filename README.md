...
- **Automated Fetching**: 
  - Posts fetch every 30 minutes from 6 AM to 5 PM (Jakarta time)
...
- **WhatsApp Notifications**: Hourly task notifications from 6 AM to 5 PM via WA Gateway
